...
import com.googlecode.gwtstreamer.test.client.shared.BasicArrayTypes;
import com.googlecode.gwtstreamer.test.client.shared.BasicTypes;
import com.googlecode.gwtstreamer.test.client.shared.ChildBean;
import com.googlecode.gwtstreamer.test.client.shared.EnumCollections;
import com.googlecode.gwtstreamer.test.client.shared.EnumCollections.Electronic;
import com.googlecode.gwtstreamer.test.client.shared.EnumCollections.Music;
import com.googlecode.gwtstreamer.test.client.shared.EnumCollections.Sex;
import com.googlecode.gwtstreamer.test.client.shared.Enums;
import com.googlecode.gwtstreamer.test.client.shared.ExtSimpleBean;
import com.googlecode.gwtstreamer.test.client.shared.IServerEcho;
import com.googlecode.gwtstreamer.test.client.shared.IServerEchoAsync;
import com.googlecode.gwtstreamer.test.client.shared.MultiArray;
import com.googlecode.gwtstreamer.test.client.shared.MyEvent1;
import com.googlecode.gwtstreamer.test.client.shared.Node;
import com.googlecode.gwtstreamer.test.client.shared.ParentBean;
...
import com.googlecode.gwtstreamer.test.client.shared.TransientBean;
...
public class GwtTestEchoStreamer extends GWTTestCase {
	...
	/*public void testSimpleMessage() {
		IServerEchoAsync echo = GWT.create( IServerEcho.class );
		echo.echo( "TEST", new AsyncCallback<String>() {
			@Override
	...
	private void checkSer( final Object o ) {
		GWT.log( "original:\t"+o.getClass()+":"+o );
		String s = Streamer.get().toString( o );
		GWT.log( "serialized:\t"+s );
		IServerEchoAsync echo = GWT.create( IServerEcho.class );
		echo.echo( s, new AsyncCallback<String>() {
			@Override
			public void onSuccess(String result) {
				GWT.log( "received:\t"+result );
				Object o1 = Streamer.get().fromString( result );
	 ...
	 */
	public void testSetStandardTypes()
	{
	...
	public void testSerTransient() {
		final TransientBean b = new TransientBean( 20, "TEST" );
		b.temp = "ABCDE";
		...
		echo.echo( s, new AsyncCallback<String>() {
			...
			public void onSuccess(String result) {
				GWT.log( "received:\t"+result );
				TransientBean b1 = (TransientBean) Streamer.get().fromString( result );
				GWT.log( "copy\t\t:"+b1.getClass()+":"+b1 );
				assertEquals( b, b1 );
	...
	public void testSerReferenceIdeitity()
	{
		...
		echo.echo( s, new AsyncCallback<String>() {
			...
			public void onSuccess(String result) {
				GWT.log( "received:\t"+result );
				Node nt = (Node) Streamer.get().fromString( result );
	...
	{
		{
			final int[] o = { 2, 3, 6, 8, 3, 8, 2, 6, 9, 0 };
			String s = Streamer.get().toString( o );
			GWT.log( "serialized:\t"+s );
			IServerEchoAsync echo = GWT.create( IServerEcho.class );
			echo.echo( s, new AsyncCallback<String>() {
				...
				public void onSuccess(String result) {
					...
					Object o1 = Streamer.get().fromString( result );
					assertEquals( o.getClass(), o1.getClass() );
					GWT.log( "copy\t\t:"+o1.getClass()+":"+Arrays.toString( (int[]) o1 ) );
	...
	public void testMultiArrays()
	{
		...
		t.c = new Enums.Month[][] { { Enums.Month.APR, Enums.Month.AUG, Enums.Month.FEB }, { Enums.Month.MAR }, {}, { Enums.Month.NOV, Enums.Month.NOV } };
		checkSer(t);
	}
